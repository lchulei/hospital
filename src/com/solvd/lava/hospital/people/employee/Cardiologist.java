...
public class Cardiologist extends Employee implements InteractWithPatient {
    private int doctorId;

    private final static Logger LOGGER = LogManager.getLogger(Cardiologist.class);
    ...
    public void examinePatient(Patient patient) {
        ...
        switch (probabilityOfDisease) {
            case 5:
                visit.setDiagnosis(Diagnosis.STROKE);
                break;
            case 6:
                visit.setDiagnosis(Diagnosis.INFARCT);
                break;
            default:
