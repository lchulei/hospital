...
public class Otorhinolaryngologist extends Employee implements ExaminePatient {
    private int doctorId;

    private static final Logger LOGGER = Logger.getLogger(Otorhinolaryngologist.class);

    public Otorhinolaryngologist() {

    }

    public Otorhinolaryngologist(String name, String surname, LocalDate birthday, String sex, String phoneNumber, String address,
