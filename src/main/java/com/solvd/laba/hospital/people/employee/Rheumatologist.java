...
public class Rheumatologist extends Employee implements ExaminePatient {
    private int doctorId;

    private static final Logger LOGGER = Logger.getLogger(Rheumatologist.class);

    public Rheumatologist() {

    }

    public Rheumatologist(String name, String surname, LocalDate birthday, String sex, String phoneNumber, String address,
